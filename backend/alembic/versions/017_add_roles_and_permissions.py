...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('is_system', sa.Boolean(), server_default='false', nullable=False),  # Cannot be deleted
    ...
    op.create_table(
        ...
        sa.Column('assigned_by', sa.Integer()),  # User ID who assigned this role
        sa.PrimaryKeyConstraint('id'),
    ...
    # Users with role='super_admin' -> super_admin role
    # Users with role='admin' -> admin role
    # Users with role='viewer' -> viewer role
    # Others -> viewer role
    op.execute("""
        ...
        WHERE 
            ...
            (u.role NOT IN ('super_admin', 'admin', 'viewer') AND r.name = 'viewer')
