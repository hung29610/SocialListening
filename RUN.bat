...
start "Backend API" cmd /k "cd /d "%ROOT_DIR%backend" && .\venv\Scripts\activate && set DATABASE_URL=postgresql://postgres:postgres@localhost:5432/social_listening && echo Starting Backend API... && echo Backend: http://localhost:8000 && echo API Docs: http://localhost:8000/docs && echo. && uvicorn app.main:app --reload --host 0.0.0.0 --port 8000"
timeout /t 5 >nul
