...
export default function MonitorSentimentChart({
  ...
  const chartData = [
    { name: t('mentions.sentiment.positive'), value: data.positive_count, color: chartColors.positive, pct: data.positive_pct },
    { name: t('mentions.sentiment.neutral'), value: data.neutral_count, color: chartColors.neutral, pct: data.neutral_pct },
    { name: t('mentions.sentiment.negative'), value: data.negative_count, color: chartColors.negative, pct: data.negative_pct },
