    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-paper/25 dark:bg-void/75 backdrop-blur-sm p-4">
      <div className="bg-void-surface border border-edge rounded-xl shadow-tile w-full max-w-[500px] overflow-hidden relative">
        ...
        <div className="p-8 pb-6 flex flex-col items-center">
          ...
          <p className="text-paper-muted text-sm font-medium mb-1">Upcoming webinar:</p>
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-4">
            <div>
              <label className="block text-sm font-bold text-paper mb-1">
                Choose your preferred time <span className="font-normal text-paper-muted">(Asia/Bangkok):</span>
              </label>
              <select
                value={time}
            ...
            <div className="flex gap-4">
              <div className="flex-1 relative">
                <label className="absolute -top-2 left-3 bg-void-surface px-1 text-xs text-paper-faint z-10">E-mail</label>
                <input
                  type="email"
                  value={email}
              ...
              <div className="flex-1 relative">
                <label className="absolute -top-2 left-3 bg-void-surface px-1 text-xs text-signal dark:text-signal-bright font-medium z-10">Name</label>
                <input
                  type="text"
                  value={name}
            ...
            <p className="text-center text-xs text-paper-faint mt-2">
              By registering I accept the <a href="#" className="text-signal dark:text-signal-bright hover:underline rounded focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-signal/70">information clause</a>
            </p>
          </form>
        </div>
      </div>
