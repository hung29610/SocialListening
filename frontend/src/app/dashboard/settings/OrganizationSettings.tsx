...
export default function OrganizationSettings() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-xl font-bold text-paper tracking-wide">Thông tin tổ chức</h2>
        <p className="text-sm text-paper-muted mt-1">Cấu hình thông tin công ty</p>
      </div>

      {/* Logo Upload */}
      <div className="bg-void-surface border border-edge rounded-xl shadow-sm p-6">
        <label className="block text-sm font-medium text-paper-muted mb-4">Logo công ty</label>
        <div className="flex items-center space-x-6">
          ...
          <div>
            ...
            <p className="text-xs text-paper-faint mt-2.5 font-medium">PNG, JPG. Tối đa 2MB. Khuyến nghị 200x200px</p>
          </div>
        </div>
      </div>
