  ...
  if (!mention) {
    return (
      <div className="text-center py-12">
        <p className="text-paper-muted font-medium tracking-wide">Không tìm thấy mention</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-paper tracking-wide">Chi tiết Mention</h1>
          <p className="text-sm text-paper-faint mt-1 font-mono">ID: {mention.id}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {keywordTexts(mention.matched_keywords).length > 0 && (
            <div className="bg-void-surface border border-edge rounded-2xl shadow-tile p-6 sm:p-8">
              <h3 className="text-lg font-bold text-paper mb-5 flex items-center">Từ khóa khớp</h3>
        ...
        <div className="space-y-6">
          ...
          {mention.ai_analysis && (
            <div className="bg-void-surface border border-edge rounded-2xl shadow-tile p-6 relative overflow-hidden">
              ...
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-lg font-bold text-paper">AI Analysis</h3>
              ...
              <div className={`p-5 rounded-xl border mb-6 flex flex-col items-center justify-center ${getRiskBgColor(mention.ai_analysis.risk_score)}`}>
                ...
                <div className="text-xs font-bold tracking-wider uppercase text-paper-faint mt-2">Risk Score</div>
              </div>

              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-edge pb-3">
                  <span className="text-sm font-medium text-paper-faint uppercase tracking-wider text-[11px]">Sentiment</span>
                  <SentimentBadge
                ...
                <div className="flex justify-between items-center border-b border-edge pb-3">
                  <span className="text-sm font-medium text-paper-faint uppercase tracking-wider text-[11px]">Crisis Level</span>
                ...
                <div className="flex justify-between items-center border-b border-edge pb-3">
                  <span className="text-sm font-medium text-paper-faint uppercase tracking-wider text-[11px]">Suggested Action</span>
                ...
                {mention.ai_analysis.responsible_department && (
                  <div className="flex justify-between items-center border-b border-edge pb-3">
                    <span className="text-sm font-medium text-paper-faint uppercase tracking-wider text-[11px]">Department</span>
                    <span className="text-sm font-semibold text-paper capitalize">
                ...
                {mention.ai_analysis.confidence_score && (
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-paper-faint uppercase tracking-wider text-[11px]">Confidence</span>
              ...
              {mention.ai_analysis.summary_vi && (
                <div className="mt-6 pt-5 border-t border-edge">
                  <h4 className="text-[11px] font-bold text-paper-faint uppercase tracking-wider mb-3">Tóm tắt AI:</h4>
                ...
                <div className="mt-6 pt-5 border-t border-edge">
                  ...
                  <div className="bg-void-raised border border-edge p-4 rounded-xl space-y-4">
                    {mention.ai_analysis.why_it_matters && (
                      <div>
                        <span className="text-[10px] font-bold text-paper-faint uppercase block mb-1">Mức độ ảnh hưởng</span>
                        <p className="text-sm text-paper-muted">{mention.ai_analysis.why_it_matters}</p>
                      </div>
                    )}
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <span className="text-[10px] font-bold text-paper-faint uppercase block mb-1">Độ khẩn cấp</span>
                      ...
                      <div>
                        <span className="text-[10px] font-bold text-paper-faint uppercase block mb-1">Đề xuất xử lý</span>
                        <span className="text-sm font-medium text-paper">{mention.ai_analysis.response_type?.replace(/_/g, ' ')}</span>
                      </div>
                      <div>
                        <span className="text-[10px] font-bold text-paper-faint uppercase block mb-1">Người phụ trách (Gợi ý)</span>
                        <span className="text-sm font-medium text-paper">{mention.ai_analysis.recommended_owner}</span>
                      </div>
                      <div>
                        <span className="text-[10px] font-bold text-paper-faint uppercase block mb-1">Thời hạn</span>
          ...
          <div className="bg-void-surface border border-edge rounded-2xl shadow-tile p-6">
            <h3 className="text-lg font-bold text-paper mb-5 uppercase tracking-widest text-[11px] border-b border-edge pb-2">Hành động xử lý</h3>
            <div className="space-y-4">
              <button
          ...
          {/* Meta Information */}
          <div className="bg-void-surface border border-edge rounded-2xl shadow-tile p-6">
            <h3 className="text-lg font-bold text-paper mb-5 uppercase tracking-widest text-[11px] border-b border-edge pb-2">Thông tin hệ thống</h3>
            <div className="space-y-4 text-sm">
              <div className="flex justify-between items-center">
                <span className="text-paper-muted font-medium">Thu thập:</span>
              ...
              {mention.published_at && (
                <div className="flex justify-between items-center">
                  <span className="text-paper-muted font-medium">Xuất bản:</span>
                  <span className="text-paper font-medium tabular-nums">
              ...
              {mention.author && (
                <div className="flex justify-between items-center">
                  <span className="text-paper-muted font-medium">Tác giả:</span>
                  <span className="text-paper font-medium">{mention.author}</span>
                </div>
              )}
              <div className="flex justify-between items-center">
                <span className="text-paper-muted font-medium">Source ID:</span>
